...
{
  internal class ThemeStatusStripElements
  {
  ...
  [ThemeKitControl("StatusStrip", typeof(ThemeStatusStripElements))]
  [ToolboxItem(true)]
  public class ThemeStatusStrip : StatusStrip
  {
    string style;

    internal ThemeStatusStripElements theme = new ThemeStatusStripElements();
    ...
    public ThemeStatusStrip(IContainer container) : this()
    {
      container.Add(this);
    }
    ...
    {
      theme = (ThemeStatusStripElements)GetStyle();
    }
