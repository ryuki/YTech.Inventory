...
{
  internal class ThemePanelElements
  {
    public ExBrush[] NormalBackground = new ExBrush[0];
  }

  [ThemeKitControl("Panel", typeof(ThemePanelElements))]
  [ToolboxItem(true)]
  public class ThemePanel : ThemeContainerControl
  {
    ThemePanelElements elements = new ThemePanelElements();
    ...
    {
      elements = (ThemePanelElements)GetStyle();
    }
  }
}
