...
namespace Inventori.MotorKymco.Data
{
	[Serializable]
	public class TMotorSetting: IEquatable<TMotorSetting>, System.ComponentModel.IEditableObject
	{
        ...
        public virtual void EndEdit()
        {
            if (_IsInEdit)
            {
                this._clone = new StructTMotorSetting();
                this._IsInEdit = false;
            }
        }
		...
		public override bool Equals( object obj )
		{
			...
			TMotorSetting castObj = (TMotorSetting)obj; 
			return ( castObj != null ) &&
		...
		public bool Equals(TMotorSetting other)
		{
			if (other == this)
				return true;
