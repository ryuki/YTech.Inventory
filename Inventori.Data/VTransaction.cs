...
{
	[Serializable]
	public class VTransaction: IEquatable<VTransaction>, System.ComponentModel.IEditableObject
	{
        ...
        public virtual void EndEdit()
        {
            if (_IsInEdit)
            {
                this._clone = new StructVTransaction();
                this._IsInEdit = false;
            }
        }
		...
		public override bool Equals( object obj )
		{
			...
			VTransaction castObj = (VTransaction)obj; 
		...
		public bool Equals(VTransaction other)
		{
			if (other == this)
				return true;
