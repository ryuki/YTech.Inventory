...
{
	[Serializable]
	public class VTransactionDealer: IEquatable<VTransactionDealer>, System.ComponentModel.IEditableObject
	{
        ...
        struct StructVTransactionDealer
        {
        ...
        StructVTransactionDealer _clone;
        ...
        public virtual void EndEdit()
        {
            if (_IsInEdit)
            {
                this._clone = new StructVTransactionDealer();
                this._IsInEdit = false;
            }
        }
		...
		public override bool Equals( object obj )
		{
			...
			VTransactionDealer castObj = (VTransactionDealer)obj; 
		...
		public bool Equals(VTransactionDealer other)
		{
			if (other == this)
				return true;
