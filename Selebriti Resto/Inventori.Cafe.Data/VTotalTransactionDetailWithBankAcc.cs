...
{
	[Serializable]
	public class VTotalTransactionDetailWithBankAcc: IEquatable<VTotalTransactionDetailWithBankAcc>, System.ComponentModel.IEditableObject
	{
		...
		public VTotalTransactionDetailWithBankAcc()
		{
        ...
        struct StructVTotalTransactionDetailWithBankAcc
        {
        ...
        StructVTotalTransactionDetailWithBankAcc _clone;
        ...
        public virtual void EndEdit()
        {
            if (_IsInEdit)
            {
                this._clone = new StructVTotalTransactionDetailWithBankAcc();
                this._IsInEdit = false;
            }
        }
		...
		public override bool Equals( object obj )
		{
			...
			VTotalTransactionDetailWithBankAcc castObj = (VTotalTransactionDetailWithBankAcc)obj; 
		...
		public bool Equals(VTotalTransactionDetailWithBankAcc other)
		{
			if (other == this)
				return true;
